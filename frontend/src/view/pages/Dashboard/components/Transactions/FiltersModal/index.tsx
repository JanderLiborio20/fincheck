...
import { useFilersModal } from './useFiltersModal';
...
const mockedAccounts = [
  { id: '123', name: 'Inter' },
  { id: '1235', name: ' Xp Investimento' },
  { id: '1236', name: 'Dinheiro' },
];

export function FiltersModal({ open, onClose, title }: FiltersModalProps) {
  const {
